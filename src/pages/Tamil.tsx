...
export function Tamil() {
  ...
  const links = [
  { text: 'ஆராய்ச்சி', href: '#', className: 'font-semibold', name: 'research', shorttext: 'Research'},
  { text: 'நோக்கம்', href: '#', name: 'team', shorttext: 'Team' },
  { text: 'இணைய', href: '#', name: 'contact', shorttext: 'Contact' },
]

  const handleDonation = () => {
    alert(`நன்றி! உங்கள் ரூ.${donationAmount} தொகை வெற்றிகரமாக பதிவு செய்யப்பட்டது.`);
...
*/}
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center">              
              ...
              <button onClick={()=> navigate('/English')} className="bg-[#BD6B14] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#6A3C0B] transition-colors">
                English
              </button>
            </div>
          </div>
      ...
      <main>
        ...
        {activeTab === 'home' && (
          <div className="relative bg-gradient-to-r from-blue-50 to-indigo-50 overflow-hidden">
            ...
            {/* ## Background Image */}
            <img src="./header-bg.jpg" alt="" className="h-full w-full max-w-full transition-all duration-300 ease-in-out 
         /* Focused/Hover state */
         hover:opacity-100 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            {/* ## Background Image */}

            {/* <div className="w-full mt-12 flex justify-center items-center"> */}
           
            {/* Main Banner Container */}
            <section className="py-12 bg-gradient-to-r from-[#BD6B14] via-[#E98B4B] to-[#F2D448] text-white">
              <div className="container mx-auto px-4 text-center">
                <h2 className="text-4xl md:text-5xl font-bold mb-4">தமிழ் மொழியை உலகெங்கும் பரப்புவோம் . . .</h2>
                <p className="text-xl max-w-2xl mx-auto mb-8">
                   தமிழ் மொழியின் வளர்ச்சி மற்றும் பரப்புக்கு உங்கள் உதவியை வழங்குங்கள்.
                </p>
                <button 
                  onClick={() => setShowDonationModal(true)}
                  className="bg-yellow-500 text-[#6A3C0B] font-bold py-3 px-8 rounded-full transition transform hover:scale-105 hover:text-[#BD6B14]"
                >
                  தானம் செய்யவும்
                </button>
              </div>
            ...
            {/* </div> */}
            <div className="flex v-screen items-center">
                ...
                <div className="pt-10 px-4 sm:px-6 lg:px-8">
                  <div className="text-center sm:text-left">
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
                      <span className="block text-[#28150D] text-3xl">உலக</span>
                      <span className="block text-[#28150D]">தமிழதிகார</span>
                      <span className="block text-[#28150D]">ஆய்வு <span className='text-[#945410] italic'>நடுவம்</span> அறக்கட்டளை </span>                      
                    </h1>
                      
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                      <span className="font-bold text-[#945410]">TAMILARI</span> ஆராய்ச்சி மற்றும் புத்தாக்கத்தின் மூலம் உலகளாவிய தமிழ் சமூகத்தின் வளர்ச்சிக்காகப் பணியாற்றுதல்.
                    </p>
        ...
        {/* Team Section */}
        {activeTab === 'team' && (
          <div className="max-w-4xl mx-auto py-4 px-2 sm:px-6 lg:px-6">
            <div><img className='w-85 h-85 mx-auto rounded-full object-cover' src='./tamil3kings.png'/></div>
            <div className="text-center -mt-10" style={pageBorderStyle}>
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
      ...
      {/* Footer */}
      <footer className="bg-[#28170A] items-center">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div>
              <h3 className="text-sm font-semibold text-white tracking-wider uppercase">World TamilARI</h3>
              <p className="mt-4 text-base text-[#FDD4A6]">
                TAMIL ARI {'>'} Authority Research Institution
              </p>
              <p className="mt-2 text-sm text-[#FDD4A6] border-t border-[#64503E] pt-2">
                Spread Tamil To The World Through Research and Innovation
              </p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-white tracking-wider uppercase">Research Areas</h3>
              <ul className="mt-4 space-y-4">
                {researchAreas.slice(0, 4).map((area) => (
                  <li><a href="#" className="text-base text-[#FDD4A6] hover:text-white">{area.title}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-white tracking-wider uppercase">More Research Areas</h3>
              <ul className="mt-4 space-y-4">
            ...
            <div>
              ...
              <ul className="mt-1 space-y-1">
                <li className="text-base text-[#FDD4A6]">70C Pauls Complex</li>
                <li className="text-base text-[#FDD4A6]">Opp. Head Post Office</li>
                <li className="text-base text-[#FDD4A6]">Tiruchirappalli - 620 001</li>
                </ul>
              <ul className="mt-4 space-y-1">
                <li className="text-base text-[#FDD4A6]">contact@tamilari.com</li>
                <li className="text-base text-[#FDD4A6]">+91-9902605045</li>
              </ul>
            </div>
          </div>
          <div className="mt-12 border-t border-[#64503E] pt-8">
            <p className="text-base text-white text-center">&copy; {new Date().getFullYear()} WTA Research Foundation. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
