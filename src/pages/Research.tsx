...
*/}
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center">              
              ...
              <button onClick={()=> navigate('/')} className="bg-[#BD6B14] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#6A3C0B] transition-colors">
                தமிழ்
              </button>
            </div>
          </div>
      ...
      <main>
         ...
         hover:opacity-100 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            ...
            <section className="py-12 bg-gradient-to-r from-[#BD6B14] via-[#E98B4B] to-[#F2D448] text-white">
              <div className="container mx-auto px-4 text-center">
                <h2 className="text-4xl md:text-5xl font-bold mb-4">Spread Tamil To The World . . .</h2>
                <p className="text-xl max-w-2xl mx-auto mb-8">
                  Please support for the growth and spread of the Tamil language.
                </p>
                <button 
                ...
                <div className="pt-10 px-4 sm:px-6 lg:px-8">
                  <div className="text-center sm:text-left">
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
                      <span className="block text-[#28150D] text-3xl">world</span>
                      <span className="block text-[#28150D]">Tamil</span>
                      <span className="block text-[#28150D]">Authority Research <span className='text-[#945410] italic'>Institution</span> Foundation</span>                      
                    </h1>
        ...
        {activeTab === 'research' && (
          <div id='research' className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
